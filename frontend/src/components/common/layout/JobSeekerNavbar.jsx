      ...
      >
        <Container maxW="8xl" px={6}>
          <Flex h={16} alignItems="center" justify="space-between">
            ...
            <NavbarSearch 
              searchQuery={navbarState.searchQuery}
              setSearchQuery={navbarState.setSearchQuery}
              isSearchFocused={navbarState.isSearchFocused}
              setIsSearchFocused={navbarState.setIsSearchFocused}
              recentSearches={navbarState.recentSearches}
              handleQuickSearch={navbarState.handleQuickSearch}
            />
